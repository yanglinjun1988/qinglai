...
<title>图片裁剪</title>
		<link href="<?php echo base_url('themes/common/jcrop/css/jquery.Jcrop.css')?>" rel="stylesheet" media="all" type="text/css">
		<link rel="stylesheet" href="<?php echo base_url('themes/common/kindeditor/themes/default/default.css')?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo base_url('themes/common/jBox/Skins/Blue/jbox.css')?>"/>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/js/jquery.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/js/jquery.form.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/jcrop/js/jquery.Jcrop.min.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/kindeditor/kindeditor-min.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/kindeditor/lang/zh_CN.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/jBox/jquery.jBox-2.3.min.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/jBox/i18n/jquery.jBox-zh-CN.js')?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('themes/common/cutting.js')?>" type="text/javascript"></script>
</head>
