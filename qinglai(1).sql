...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-12-12 11:01:42
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `ims_ewei_shop_category` (`id`, `uniacid`, `catename`, `thumb`, `parentid`, `isrecommand`, `description`, `displayorder`, `enabled`, `ishome`, `advimg`, `advurl`, `level`) VALUES
(2, 0, NULL, NULL, 0, 0, '阿斯蒂芬', 0, 1, 0, '', NULL, NULL),
(3, 0, '测试', NULL, 0, 0, '撒地方', 0, 1, 0, '', NULL, NULL),
(4, 0, '我的世界', NULL, 0, 0, '撒地方', 0, 1, 0, '阿斯蒂芬', NULL, NULL);
